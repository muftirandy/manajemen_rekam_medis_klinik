 ...
 <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Catatan REKAM MEDIS</li>
        

    </ol>

      <center><h4><i class="fa fa-id-card-o"></i> Catatan Rekam Medis</i></h4></center>
      <hr>
  ...
  <div class="col-md-12">
    ...
    <form method="POST" class="form" action="proses_rekammedis.php?nip=<?php echo $_GET['nip'] ?>&kode=2&id=">
      ...
      <div class="form-group">
        <textarea class="form-control" name="keluhan" placeholder="Keluhan" style="width:1000px;"></textarea>
      </div>
      <div class="form-group">
        <textarea class="form-control" name="pemeriksaan" placeholder="Pemeriksaan" style="width:1000px;"></textarea>
      </div>
      <div class="form-group">
        <textarea class="form-control" name="diagnosa" placeholder="Diagnosa" style="width:1000px;"></textarea>
      </div>
      <div class="form-group">
        <textarea class="form-control obat" id="pil_obat" placeholder="obat" name="obat" wrap="hard" style="width:1000px;"></textarea>
      <!-- <input type="text" class="form-control obat" name="obat" id="pil_obat" placeholder="Obat" value="" style="width:500px;"> -->
      </div>
       <div class="form-group">
        <textarea type="text" class="form-control" name="terapi" placeholder="Terapi" style="width:1000px;"></textarea>
      </div>
...
<!--         <div class="card-body"> -->
        ...
        <?php
          ...
          ?>
                ...
                <td width="200px"> <?php echo $data['keluhan'];?> </td>
                <td width="200px"> <?php echo $data['pemeriksaan'];?> </td>
                <td width="200px"> <?php echo $data['diagnosa'];?> </td>
                <td width="200px"> <?php echo $data['obat'];?> </td>
                <td width="200px"> <?php echo $data['terapi'];?> </td>
                <td style="display: none;"> <?php echo $data['id'];?> </td>
                <td align="pull-right" width="100px">
                  <?php if ($data['namadokter'] == $_SESSION['user_id']) { ?>
                   <!--  <a href="home.php?link=13&nip=<?php echo $data['nip']; ?>&id=<?php echo $data['id']; ?>" class="btn btn-outline btn-warning btn-sm" title="Edit Data"><span class="fa fa-pencil-square-o"> Edit</span></a>
                    &nbsp -->
                    <a href="print_rekammedis.php?nip=<?php echo $data['nip'];?>&id=<?php echo $data['id']; ?>" class="btn btn-success btn-sm " title="Print"><i class="fa fa-print"></i></a>
                    &nbsp
                    <a href="proses_rekammedis.php?kode=1&nip=<?php echo $data['nip']; ?>&id=<?php echo $data['id']; ?>" onclick="return confirm('hapus data?');" class="btn btn-outline btn-danger btn-sm" title="Hapus Data"><span class="fa fa-trash"></span></a>
                  <?php }else{}  ?>
                </td>
 ...
 <div class="card-body">
        ...
        <?php
          ...
          include "../koneksi.php";
            ...
            LEFT JOIN kategori b ON c.kategori = b.id ORDER BY tanggalexpired ASC";
            $sql= mysqli_query($connect,$query);
            $id = 1;
