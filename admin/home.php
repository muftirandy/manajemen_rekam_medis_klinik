        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav sidebar-dark bg-dark fixed-bottom ">
                ...
                <li title="Data Pasien">
                 ...
                 <li class="nav-item" data-toggle="tooltip" data-placement="right"  >
                  <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti" data-parent="#exampleAccordion">
                    <i class="fa fa-medkit"></i> Master Obat
                    <span class="nav-link-text"></span>
                  </a>
                  <ul class="sidenav-second-level collapse" id="collapseMulti">
                    <li title="Obat Masuk">
                      <a href="home.php?link=11"> Obat Masuk</a>
                    </li>
                    <li title="Data Obat">
                      <a href="home.php?link=3"> Data Obat</a>
                    </li>
                    </ul>
                  </li>
                ...
                <li title="User Management">
                  <a href="home.php?link=14"> <i class="fa fa-user-circle" aria-hidden="true"></i> User Management</a>
                </li>
                </li>
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="home.php?link=3">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="home.php?link=14">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
...
<script>
    $(function(){
    $("#datepicker, #tanggal, #tanggalmasuk, #dari, #sampai").datepicker({
    format:'dd-mm-yyyy'
    });
    });
 </script>
 ...
 <script type="text/javascript">
    $(document).ready(function(){
        $("#table_obat, #table_rekammedis, #table_catatan_rekammedis, #table_user").DataTable()
    });
</script>
